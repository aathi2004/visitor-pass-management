...
const NAV_BY_ROLE = {
  admin: [
    ...
    { to: '/assignments', label: 'Visitor Allotments', icon: 'visitors' },
    { to: '/users', label: 'User Accounts', icon: 'users' },
    { to: '/reports', label: 'Reports', icon: 'reports' },
    { to: '/activities', label: 'Activity Log', icon: 'activities' },
    { to: '/audit-logs', label: 'Audit Trail', icon: 'activities' },
  ...
  receptionist: [
    ...
    { to: '/assignments', label: 'Visitor Allotments', icon: 'employees' },
  ],
  employee: [
    { to: '/', label: 'Dashboard', icon: 'dashboard' },
...
const TITLES = {
  ...
  '/assignments': 'Employee Visitor Allotments',
};
...
export default function Layout() {
  ...
  const navItems = [...(NAV_BY_ROLE[user?.role] || []), ...COMMON_NAV];
